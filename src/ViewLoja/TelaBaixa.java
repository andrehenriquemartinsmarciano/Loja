 ...
 * @author andre
 */
public class TelaBaixa extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBaixa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
